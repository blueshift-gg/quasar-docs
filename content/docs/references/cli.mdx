...
Generate the IDL JSON and standalone Rust client for a program crate.
...
| `--lang <LANGUAGES>` | Comma-separated subset of `typescript`, `python`, `golang`, or `c`; omit it to generate all four |
