...
**Store bumps** — `find_program_address` searches for the bump. A typed-seeds
account with a `bump: u8` field can verify existing accounts through the stored
bump after initialization.
