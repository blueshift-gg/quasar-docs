...
pub struct Make {
    ...
    #[account(init(idempotent), payer = maker, token::mint = mint_b, token::authority = maker)]
    pub maker_ta_b: Account<Token>,
    #[account(init(idempotent), payer = maker, token::mint = mint_a, token::authority = escrow)]
...
use {
    ...
    quasar_lang::prelude::*,
    quasar_spl::{Mint, Token, TokenClose, TokenCpi, TokenProgram},
};
...
pub struct Take {
    ...
    #[account(init(idempotent), payer = taker, token::mint = mint_b, token::authority = maker)]
    pub maker_ta_b: Account<Token>,
    #[account(mut)]
    pub vault_ta_a: Account<Token>,
    pub rent: Sysvar<Rent>,
...
pub struct Refund {
    ...
    pub escrow: Account<Escrow>,
    pub mint_a: Account<Mint>,
    #[account(init(idempotent), payer = maker, token::mint = mint_a, token::authority = maker)]
    pub maker_ta_a: Account<Token>,
    #[account(mut)]
    pub vault_ta_a: Account<Token>,
    pub rent: Sysvar<Rent>,
